package h_java_collection_framework.practice.linked_list_don_gian;
...
public class TestLinkedList {
    public static void main(String[] args) {
        ...
        Student student2 = new Student(2, "Trung2");
        Student student3 = new Student(3, "Trung3");
        Student student4 = new Student(4, "Trung4");
        Student student5 = new Student(5, "Trung5");
